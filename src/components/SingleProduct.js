            ...
            { singleProduct ? <div>
                <div className='single-product-info'>
                    ...
                    <div className='single-product-add-to-cart'>
                        ...
                        <button className='add-to-cart' data-id={singleProduct.id} onClick={addToCart}><img data-id={singleProduct.id} src="https://i.ibb.co/T807tDQ/addtocart.png" alt="ADD TO CART" /></button>
                    </div>
